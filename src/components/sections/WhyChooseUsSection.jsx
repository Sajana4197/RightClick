    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            {CARDS.map((card, i) => {
              const activeWidth = 60; // % taken by the active panel
              const remaining = 100 - activeWidth;
              const inactiveWidth = remaining / (CARDS.length - 1);
              const width = i === activeIndex ? activeWidth : inactiveWidth;
...
function DisclosurePanel({ card, index, active, width }) {
  return (
    <li
      data-idx={index}
      data-active={active}
    ...
    >
      ...
      <h3
        style={{
          position: "absolute",
          top: active ? "1.25rem" : "1.25rem",
          left: active ? "1.5rem" : "1.5rem",
          transformOrigin: "0 50%",
          rotate: active ? "0deg" : "90deg",
          fontSize: active ? "22px" : "15px",
          fontWeight: 700,
      ...
      {/* Icon — top, fades as panel expands */}
      <div
        style={{
          position: "absolute",
          top: "1.25rem",
