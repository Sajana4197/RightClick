...
import { FaSearch, FaClipboardList, FaRocket, FaCog, FaChartLine } from 'react-icons/fa'
import { fadeInUp, staggerContainer, viewportOnce } from '../../animations/variants'

gsap.registerPlugin(ScrollTrigger)

const STEPS = [
  { num: '01', icon: <FaSearch />,        title: 'Discover', desc: 'We learn about your business and goals.' },
  { num: '02', icon: <FaClipboardList />, title: 'Plan',     desc: 'We design a custom IT strategy for you.' },
  { num: '03', icon: <FaRocket />,        title: 'Deploy',   desc: 'We implement with minimum disruption.' },
  { num: '04', icon: <FaCog />,           title: 'Manage',   desc: 'We proactively monitor and support your IT.' },
  { num: '05', icon: <FaChartLine />,     title: 'Optimize', desc: 'We continuously improve and scale as you grow.' },
]
    ...
    <div className="flex flex-col items-center flex-1 relative">
      ...
      >
        ...
        <motion.div
          ...
          animate={hovered ? { scale: 1.35, opacity: 0 } : { scale: 1, opacity: 0.4 }}
          transition={hovered
          ...
          animate={
            hovered
              ? {
                  ...
                  boxShadow: '0 0 0 4px rgba(30,144,255,0.18), 0 0 28px rgba(30,144,255,0.55)',
                }
              : {
                  backgroundColor: 'rgba(12,20,36,1)',
                  borderColor: 'rgba(30,144,255,0.45)',
                  boxShadow: '0 0 0 4px rgba(30,144,255,0.06), 0 0 12px rgba(30,144,255,0.18)',
                }
          }
...
export default function ProcessSection() {
  ...
  return (
    <section id="process" ref={sectionRef} className="section-py bg-dark-800 relative overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 bg-dots opacity-40" />
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[60%] h-[60%] opacity-15"
          style={{ background: 'radial-gradient(ellipse, rgba(30,144,255,0.12) 0%, transparent 70%)' }}
        />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.p variants={fadeInUp} className="eyebrow mb-3">Our Process</motion.p>
        ...
        <div className="hidden lg:block relative">
          ...
          */}
          <div
            ...
            style={{ top: CIRCLE_SIZE / 2, height: '2px', transform: 'translateY(-50%)' }}
          >
            {/* Track */}
          ...
          <div className="flex items-start">
            {STEPS.map((step, i) => (
              <StepNode key={step.num} step={step} index={i} total={STEPS.length} />
            ))}
          </div>
        </div>
