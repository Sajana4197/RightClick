...
import {
  FaMapMarkerAlt, FaBriefcase, FaClock, FaArrowRight, FaTimes,
  FaSearch, FaHeart, FaGraduationCap, FaUsers, FaLaptopHouse, FaPiggyBank,
} from 'react-icons/fa'
import { fadeInUp, fadeIn, staggerContainer, viewportOnce } from '../animations/variants'
import { scrollToSection } from '../hooks/useLenis'

// ── Data ──────────────────────────────────────────────────────────────────
const DEPARTMENTS = ['All', 'Engineering', 'Support', 'Sales', 'Operations', 'Security']
...
const BENEFITS = [
  { icon: <FaHeart />,        title: 'Health & Wellness', desc: 'Medical, dental, and vision coverage for you and your family.' },
  { icon: <FaPiggyBank />,    title: '401(k) Matching',   desc: 'We match contributions to help you plan for the future.' },
  { icon: <FaLaptopHouse />,  title: 'Flexible Work',     desc: 'Remote, hybrid, and on-site roles depending on the team.' },
  { icon: <FaGraduationCap />, title: 'Growth & Training', desc: 'Certification reimbursement and dedicated learning time.' },
  { icon: <FaUsers />,        title: 'Team Culture',      desc: 'A supportive, collaborative team that has your back.' },
  { icon: <FaClock />,        title: 'Paid Time Off',     desc: 'Generous PTO, holidays, and a healthy work-life balance.' },
]
    ...
    <main className="bg-dark-900">
      ...
      <section className="relative overflow-hidden pt-32 pb-20 lg:pt-40 lg:pb-28">
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div
            className="absolute top-0 right-0 w-[60%] h-[70%] opacity-25"
            style={{ background: 'radial-gradient(ellipse at 75% 15%, rgba(30,144,255,0.16) 0%, transparent 65%)' }}
          />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <motion.div variants={fadeInUp} className="flex items-center justify-center gap-2 mb-5">
              ...
              <span className="eyebrow text-[11px]">Careers at RightClicks</span>
            </motion.div>
            <motion.h1
              variants={fadeInUp}
            ...
            <motion.p variants={fadeInUp} className="section-sub max-w-2xl mx-auto mb-10">
              We're a team of problem-solvers who take pride in keeping businesses
              secure, productive, and ahead of the curve. Come help us do it.
            </motion.p>
            <motion.div variants={fadeInUp}>
              <button onClick={() => scrollToSection('open-roles')} className="btn-primary">
      ...
      <section className="section-py bg-dark-800 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div
            ...
            style={{ background: 'radial-gradient(ellipse at 15% 85%, rgba(30,144,255,0.14) 0%, transparent 65%)' }}
          />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.p variants={fadeInUp} className="eyebrow mb-3">Why Work Here</motion.p>
          ...
          >
            {BENEFITS.map((b) => (
              <motion.div
                ...
                variants={fadeInUp}
                whileHover={{ y: -4 }}
                className="glass-card p-6 flex flex-col gap-3 hover:border-brand-blue/40 transition-colors duration-300"
              >
                <div className="w-11 h-11 rounded-lg bg-brand-blue/12 border border-brand-blue/20 flex items-center justify-center text-brand-blue text-lg">
                  {b.icon}
                </div>
                <h3 className="text-white font-semibold text-[15px]">{b.title}</h3>
                <p className="text-neutral-400 text-[13px] leading-relaxed">{b.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      {/* ── Open Roles ── */}
      <section id="open-roles" className="section-py bg-dark-900 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.p variants={fadeInUp} className="eyebrow mb-3">Open Positions</motion.p>
            <motion.h2 variants={fadeInUp} className="section-heading">
              Find Your{' '}
              <span className="text-gradient-blue">Next Role</span>
            </motion.h2>
          </motion.div>
          ...
          >
            <AnimatePresence mode="popLayout">
              {filteredJobs.length > 0 ? (
                filteredJobs.map((job) => (
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      ...
                      <h3 className="text-white font-bold text-lg leading-snug mb-1.5">{job.title}</h3>
                ...
                >
                  <p className="text-neutral-400 text-sm mb-2">No roles match your search right now.</p>
                  <p className="text-neutral-500 text-xs">
                    Don't see the right fit? Send your resume to{' '}
                    <a href="mailto:careers@rightclicks.com" className="text-brand-blue hover:underline">
      ...
      <section className="section-py bg-dark-800 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div
            ...
            style={{ background: 'radial-gradient(ellipse at 85% 15%, rgba(30,144,255,0.14) 0%, transparent 65%)' }}
          />
        </div>
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="section-sub mb-8 max-w-md mx-auto">
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-white font-bold text-2xl leading-snug mb-3 pr-10">{job.title}</h2>
        ...
        <p className="text-neutral-300 text-sm leading-relaxed mb-6">{job.desc}</p>
        ...
        <ul className="flex flex-col gap-2.5 mb-8">
          {job.requirements.map((req) => (
            <li key={req} className="flex items-start gap-2.5 text-neutral-400 text-sm leading-relaxed">
